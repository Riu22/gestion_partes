...
public class pdf_controller {
    ...
    /**
     * Genera y devuelve un PDF con los partes filtrados.
     *
     * Query params:
     *   desde      — fecha inicio yyyy-MM-dd (obligatorio)
     *   hasta      — fecha fin   yyyy-MM-dd (obligatorio)
     *   obraIds    — lista de IDs de obras   (opcional, vacío = todas)
     *   perfilIds  — lista de IDs de perfiles (opcional, vacío = todos)
     */
    @GetMapping("/partes")
